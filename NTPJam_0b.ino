 ...
 * v0a - corrected 0:00 hour 
 * v0b - usd setPixel(x,y,color) instead lined and space for seconds 
*/
...
//dmd.setPixel(14,0,Det%2);  // blink point
//dmd.setPixel(14,0,1);  // 1 - on, 0 = off

dmd.drawLine(x+15,y+2,x+15,y+3,Det%2);
dmd.drawLine(x+15,y+7,x+15,y+8,Det%2);
dmd.drawLine(x+15+tip%2,y+2,x+15+tip%2,y+3,Det%2);
dmd.drawLine(x+15+tip%2,y+7,x+15+tip%2,y+8,Det%2);
/*
if (millis()/1000%2 == 1)
{
